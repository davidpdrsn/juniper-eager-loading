...
//         fn load(ids: &[i32], _: &(), ctx: &Self::Context) -> Self::Future {
//             let models = ctx
//                 .db
//                 .users
//                 .all_values()
...
//         fn load(ids: &[i64], _: &(), ctx: &Self::Context) -> Self::Future {
//             let countries = ctx
//                 .db
//                 .countries
//                 .all_values()
...
//         fn load(users: &[User], _: &(), ctx: &Self::Context) -> Self::Future {
...
//         fn load(visits: &[Visit], _: &(), ctx: &Self::Context) -> Self::Future {
